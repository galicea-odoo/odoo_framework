...
var EventRegistrationForm = Widget.extend({
    start: function() {
        ...
        var res = this._super.apply(this.arguments).then(function() {
            $('#group_registration_form .a-submit')
                .off('click')
    ...
    on_click: function(ev) {
        ...
        var post = {};
        $("#group_registration_form select").each(function() {
...
web_editor_base.ready().then(function(){
    var event_registration_form = new EventRegistrationForm().appendTo($('#group_registration_form'));
});
